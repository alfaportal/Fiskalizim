...
const TRANSLATIONS = Object.freeze({
  sq: Object.freeze({
    ...
    payment_mode_credit: "KREDIT",
    payment_mode_sms: "SMS",
    payment_mode_bank: "BANKË",
    ...
    e_kuponi: "e-kuponi",
    mixed_payment: "E PËRZIER",
    previous_hash: "Hash-i paraprak:",
    current_hash: "Hash-i aktual:",
    integrity_check: "Kontrolli i integritetit:",
    hash_chain_title: "ZINJIRI HASH / ATK",
    report_x: "RAPORTI X (MODI X)",
    report_z: "RAPORTI FISKAL DITOR (Z)",
    report_periodic: "RAPORTI PERIODIK",
    report_subtitle_periodic: "Mes dy datave — JO mbyllje",
    report_subtitle_x: "Gjendja aktuale — JO mbyllje",
    report_subtitle_z: "Mbyllje zyrtare e ditës",
    report_business: "Biznesi:",
    report_unit: "Njësia:",
    report_sef_id: "SEF ID:",
    report_coupon_count: "Nr. kuponësh:",
    report_total_eur: "Totali (EUR):",
    report_total_without_vat: "Tot. pa TVSH:",
    report_vat_a: "TVSH A:",
    report_vat_b: "TVSH B:",
    report_vat_c: "TVSH C:",
    report_vat_d: "TVSH D 8%:",
    report_vat_e: "TVSH E 18%:",
    report_offline: "Offline:",
    report_daily_reset: "Reset ditor:",
    report_daily_closure: "Mbyllje ditore:",
    report_z_closure_done: "PO — mbyllur, numri ditor u resetua",
    report_z_closure_earlier: "Mbyllur — reset i kryer më parë sot",
    report_no_periodic: "JO (periodik)",
    report_no_mod_x: "JO (Modi X)",
    report_yes: "PO",
    report_no_already: "JO (tashmë)",
    report_print_many: "Mund të printohet shumë herë",
    report_pef_cleared: "PEF/SF ËSHTË PASTRUAR",
    report_pef_cleared_earlier: "PEF/SF — pastruar në mbylljen e parë sot",
    report_rfd_created: "RFD të krijuara:",
    report_end_z: "Fundi i raportit Z",
    report_short_periodic_title: "RAPORT FISKAL PERIODIK I PËRMBLEDHUR",
    report_nf_vat: "NF / TVSH:",
    report_from_date: "Data fillimit:",
    report_to_date: "Data fundit:",
    report_fiscalization: "Fiskalizimi:",
    report_rfd_coupons: "Nr. RFD / kuponë:",
    report_turnover_with_vat: "Qarkullim me TVSH:",
    report_total_vat_tax: "Tatim TVSH total:",
    report_turnover_by_rate: "Qarkullimi sipas normës:",
    report_tax_by_rate: "Tatimi sipas normës:",
    report_rate_a_0: "  A (0%):",
    report_rate_c_0: "  C (0%):",
    report_rate_d_8: "  D (8%):",
    report_rate_e_18: "  E (18%):",
    report_tax_a: "  A:",
    report_tax_c: "  C:",
    report_tax_d: "  D:",
    report_tax_e: "  E:",
    report_end: "Fundi i raportit",
    report_monthly_memory: "RAPORTI MUJOR I MEMORIES FISKALE",
    report_transferred_atk: "I TRANSFERUAR NË SISTEMIN E ATK",
    report_fiscalization_date: "Data fiskalizimit:",
    report_fiscalization_time: "Ora fiskalizimit:",
    report_rfd_in_period: "Nr. RFD në periudhë:",
    report_ram_resets: "Resetime RAM (Z):",
    report_payment_methods: "Mënyra e pagesës:",
    report_no_payments: "  (pa pagesa):",
    report_transmission_ok: "Transmetimi OK",
    report_transmission_fail: "Transmetimi jo OK",
    phone_label: "Tel:",
    ...
    // —— Layout kupon ATK (Shtojca F) ——
    atk_taxpayer: "TATIMPAGUESI",
    atk_unit_name: "EMRI I NJESISE",
    atk_unit_address: "ADRESA E NJESISE",
    atk_place: "VENDI",
    atk_phone: "TELEFONI",
    atk_nf_nui: "NF-NUI",
    atk_vat_number: "NUMRI I TVSH-SE",
    atk_worker_name: "EMRI I PUNETORIT",
    atk_item_col: "ARTIKULLI",
    atk_qty_price_col: "SASIA X CMIMI",
    atk_sum_col: "SHUMA",
    atk_subtotal: "NENTOTALI",
    atk_total_pay: "TOTALI PER PAGESE",
    atk_total_no_vat: "TOTALI PA TVSH",
    atk_payment_method: "MENYRA E PAGESES",
    atk_date_time: "DATA DHE ORA",
    atk_sef_id: "NR. IDENTIFIKUES I SEF",
    atk_items_count: "ARTIKUJ",
    atk_return_items_title: "KTHIMI I ARTIKUVE",
    atk_returned_items: "ARTIKUJ TE KTHYER",
    atk_return_total: "TOTALI I KTHIMIT",
    atk_remaining_total: "TOTALI I MBETUR",
    receipt_fiscal_return: "KUPON FISKAL KTHIMI",
    receipt_fiscal_cancelled: "KUPON FISKAL I ANULUAR",
    atk_coupon_nr: "KUPON FISKAL NR.",
    atk_date_label: "DATE",
    atk_cancel_reason: "ARSYEJA E ANULIMIT",
    discount_cart: "ULJE",
    discount_line_word: "Ulje",
    surcharge_line_word: "Rritje",
  ...
  sr: Object.freeze({
    ...
    e_kuponi: "e-kupon",
    mixed_payment: "MEŠOVITO",
    previous_hash: "Prethodni hash:",
    current_hash: "Trenutni hash:",
    integrity_check: "Provera integriteta:",
    hash_chain_title: "LANAC HASH / ATK",
    report_x: "IZVEŠTAJ X (MOD X)",
    report_z: "DNEVNI FISKALNI IZVEŠTAJ (Z)",
    report_periodic: "PERIODIČNI IZVEŠTAJ",
    report_subtitle_periodic: "Između datuma — BEZ zatvaranja",
    report_subtitle_x: "Trenutno stanje — BEZ zatvaranja",
    report_subtitle_z: "Zvanično dnevno zatvaranje",
    report_business: "Preduzeće:",
    report_unit: "Jedinica:",
    report_sef_id: "SEF ID:",
    report_coupon_count: "Br. kupona:",
    report_total_eur: "Ukupno (EUR):",
    report_total_without_vat: "Ukup. bez PDV:",
    report_vat_a: "PDV A:",
    report_vat_b: "PDV B:",
    report_vat_c: "PDV C:",
    report_vat_d: "PDV D 8%:",
    report_vat_e: "PDV E 18%:",
    report_offline: "Offline:",
    report_daily_reset: "Dnevni reset:",
    report_daily_closure: "Dnevno zatvaranje:",
    report_z_closure_done: "DA — zatvoreno, dnevni broj resetovan",
    report_z_closure_earlier: "Zatvoreno — reset već izvršen ranije danas",
    report_no_periodic: "NE (periodični)",
    report_no_mod_x: "NE (Mod X)",
    report_yes: "DA",
    report_no_already: "NE (već)",
    report_print_many: "Može se štampati više puta",
    report_pef_cleared: "PEF/SF JE OČIŠĆEN",
    report_pef_cleared_earlier: "PEF/SF — očišćen pri prvom zatvaranju danas",
    report_rfd_created: "RFD kreirane:",
    report_end_z: "Kraj Z izveštaja",
    report_short_periodic_title: "SAŽETI PERIODIČNI FISKALNI IZVEŠTAJ",
    report_nf_vat: "NF / PDV:",
    report_from_date: "Datum početka:",
    report_to_date: "Datum kraja:",
    report_fiscalization: "Fiskalizacija:",
    report_rfd_coupons: "Br. RFD / kupona:",
    report_turnover_with_vat: "Promet sa PDV:",
    report_total_vat_tax: "Ukupan PDV:",
    report_turnover_by_rate: "Promet po stopi:",
    report_tax_by_rate: "Porez po stopi:",
    report_rate_a_0: "  A (0%):",
    report_rate_c_0: "  C (0%):",
    report_rate_d_8: "  D (8%):",
    report_rate_e_18: "  E (18%):",
    ...
    report_tax_d: "  D:",
    report_tax_e: "  E:",
    report_end: "Kraj izveštaja",
    report_monthly_memory: "MESEČNI IZVEŠTAJ FISKALNE MEMORIJE",
    report_transferred_atk: "PRENET U ATK SISTEM",
    report_fiscalization_date: "Datum fiskalizacije:",
    report_fiscalization_time: "Vreme fiskalizacije:",
    report_rfd_in_period: "Br. RFD u periodu:",
    report_ram_resets: "RAM reseti (Z):",
    report_payment_methods: "Način plaćanja:",
    report_no_payments: "  (bez plaćanja):",
    report_transmission_ok: "Prenos OK",
    report_transmission_fail: "Prenos nije OK",
    phone_label: "Tel:",
    ...
    // —— Layout kupon ATK (Shtojca F) ——
    atk_taxpayer: "PORESKI PLATILAC",
    atk_unit_name: "NAZIV JEDINICE",
    atk_unit_address: "ADRESA JEDINICE",
    atk_place: "MESTO",
    atk_phone: "TELEFON",
    atk_nf_nui: "NF-PIB",
    atk_vat_number: "PDV BROJ",
    atk_worker_name: "IME RADNIKA",
    atk_item_col: "ARTIKAL",
    atk_qty_price_col: "KOL. X CENA",
    atk_sum_col: "IZNOS",
    atk_subtotal: "MEĐUZBIR",
    atk_total_pay: "UKUPNO ZA PLAĆANJE",
    atk_total_no_vat: "UKUPNO BEZ PDV",
    atk_payment_method: "NAČIN PLAĆANJA",
    atk_date_time: "DATUM I VREME",
    atk_sef_id: "SEF IDENT. BR.",
    atk_items_count: "ARTIKLI",
    atk_return_items_title: "POVRAT ARTIKALA",
    atk_returned_items: "VRAĆENI ARTIKLI",
    atk_return_total: "IZNOS POVRATA",
    atk_remaining_total: "PREOSTALI IZNOS",
    receipt_fiscal_return: "FISKALNI KUPON POVRATA",
    receipt_fiscal_cancelled: "STORNIRANI FISKALNI KUPON",
    atk_coupon_nr: "FISKALNI KUPON BR.",
    atk_date_label: "DATUM",
    atk_cancel_reason: "RAZLOG STORNIRANJA",
    discount_cart: "POPUST",
    discount_line_word: "Popust",
    surcharge_line_word: "Poskupljenje",
